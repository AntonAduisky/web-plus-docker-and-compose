...
let WishlistsController = class WishlistsController {
    ...
    async createWishlist(req, createWishlistDto) {
    ...
    async findWishlistById(id) {
        ...
        if (!wishlist) {
            throw new common_1.NotFoundException('Не найдено');
        }
        return wishlist;
    }
    updateWishlistById({ user }, id, updateWishlistDto) {
        return this.wishlistsService.updateWishlist(id, updateWishlistDto, user.id);
    }
    removeWishlistById({ user }, id) {
...
], WishlistsController.prototype, "findAllWishlists", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], WishlistsController.prototype, "findWishlistById", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], WishlistsController.prototype, "removeWishlistById", null);
